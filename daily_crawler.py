...
class DailyCrawler:
    def __init__(self):
        ...
        ts.set_token('28492f7fd1111fc927de4e15ce92501a97d6e55b9240be114e3eac5e')
    ...
    def crawl_index(self, begin_date=None, end_date=None):
        ...
        for code in index_codes:
            # 抓取一个指数的在时间区间的数据
            df_daily = ts.pro_bar(code, start_date=begin_date, end_date=end_date)
            # 保存数据
    ...
    def crawl(self, begin_date=None, end_date=None):
        ...
        for code in codes:
            ...
            # 抓取后复权的价格
            df_daily_hfq = ts.pro_bar(code, start_date=begin_date, end_date=end_date, adj='hfq')
...
if __name__ == '__main__':
    ...
    dc.crawl_index('2024-01-01', '2024-12-31')
    # 抓取指定日期范围的股票日行情
    # 这两个参数可以根据需求改变，时间范围越长，抓取时花费的时间就会越长
    dc.crawl('2024-01-01', '2024-12-31')
